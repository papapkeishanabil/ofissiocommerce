...
export const ADMIN_ROLE_PERMISSIONS: Record<InternalRole, AdminPermission[]> = {
  ...
  finance_internal: ["admin:view", "admin:quotation:view", "admin:order:view", "admin:order:update", "admin:process-order:view"],
  ...
  ppic: ["admin:view", "admin:order:view", "admin:process-order:view", "admin:process-order:update", "admin:tracking:view", "admin:tracking:update"],
  qc: ["admin:view", "admin:order:view", "admin:process-order:view", "admin:process-order:update", "admin:tracking:view", "admin:tracking:update"],
  logistics: ["admin:view", "admin:order:view", "admin:process-order:view", "admin:process-order:update", "admin:tracking:view", "admin:tracking:update"],
  support: [
    "admin:view",
    "admin:quotation:view",
    "admin:order:view",
