      ...
      <div className="grid grid-cols-2 gap-1.5">
        {INDUSTRY_META.map((m) => (
          <button
            ...
            className="group relative flex flex-col items-start gap-1 overflow-hidden rounded-xl border border-line bg-surface p-2.5 text-left transition-all duration-200 hover:-translate-y-0.5 hover:border-brand-200 hover:bg-white/60 hover:shadow-soft-md hover:backdrop-blur-md focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600"
          >
            <span className="grid h-7 w-7 place-items-center rounded-lg bg-brand-50 text-[13px] font-extrabold text-brand-700 transition-colors group-hover:bg-white/80 group-hover:text-brand-700">
              {m.name.charAt(0)}
            </span>
